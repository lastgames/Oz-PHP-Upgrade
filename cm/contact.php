...
if($page == '2') // Zombie
 ...
 print "Forum Groups: <a href='/forum/memberlist.php?mode=group&g=13'>$group_name[group_name]</a><br><br>Privacy: email visible to group members only<br><ul style='list-style-type: none;'>";
 }
else if($page == '3') // Oz
 { 
 ...
 print "</ul>Privacy: email visible to group members only<br><br>"; 
 }
else // LAST
 { 
 print "Forum Groups: <ul style='list-style-type: none;'>";
 ...
 print "</ul>Privacy: Web Manager emails are public, LAST Games emails are private<br><br>";
 }
...
print "</td></tr><tr><td></td><td>"; if(!empty($errorvery)){echo "<div id=orange>reCAPTCHA was not entered correctly. Please try again.</div><br>";} 
 ...
 print "<tr><td></td><td><input type='hidden' name='S_ID' value='contactform'><input type='hidden' name='page' value='$page'><input type='submit' value='' id='form_submit'></td></tr>";
